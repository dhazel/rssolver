...
with Matchers with OptionValues with ConfigAble {
  ...
  it should "contain the correct rss items" in {
    ...
    (rss \ "channel" \ "item" \ "description")(0).text should fullyMatch regex """\$2,800 +\(neighborhood1\) +3\.1mi &lt;a href=&quot;https://test\.example\.org/2005-honda-civic-ex/test1\.html&quot; class=&quot;result-image gallery&quot;&gt; &lt;span class=&quot;result-price&quot;&gt;\$2,800&lt;/span&gt; &lt;img alt=&quot;&quot; class=&quot;&quot; src=&quot;test_simple_files/test1\.jpg&quot;&gt;&lt;/a&gt;"""
    (rss \ "channel" \ "item" \ "description")(1).text should fullyMatch regex """\$7,000 +\(neighborhood2\) +5\.5mi &lt;a href=&quot;https://test\.example\.org/2009-honda-civic-lx/test2\.html&quot; class=&quot;result-image gallery&quot;&gt; &lt;span class=&quot;result-price&quot;&gt;\$7,000&lt;/span&gt; &lt;img alt=&quot;&quot; class=&quot;&quot; src=&quot;test_simple_files/test2\.jpg&quot;&gt;&lt;/a&gt;"""
    (rss \ "channel" \ "item" \ "description")(2).text should fullyMatch regex """\$2,900 +\(neighborhood2\) +5\.6mi &lt;a href=&quot;https://test\.example\.org/2004-honda-civic-ex-manual-coupe/test3\.html&quot; class=&quot;result-image gallery&quot;&gt; &lt;span class=&quot;result-price&quot;&gt;\$2,900&lt;/span&gt; &lt;img alt=&quot;&quot; class=&quot;&quot; src=&quot;test_simple_files/test3\.jpg&quot;&gt;&lt;/a&gt;"""
    (rss \ "channel" \ "item" \ "description")(3).text should fullyMatch regex """\$3,500 +5\.9mi &lt;a href=&quot;https://test\.example\.org/2009-honda-civic/test4\.html&quot; class=&quot;result-image gallery empty&quot; title=&quot;no image&quot;&gt;&lt;/a&gt;"""
  }
